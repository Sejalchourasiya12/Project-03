...
<%@page import="in.co.rays.project_3.dto.SubscriptionPlanDTO"%>
...
<body class="hm">
<div>
    <form class="pb-5" action="<%=ORSView.SUBSCRIPTION_PLAN_LIST_CTL%>" method="post">
        ...
        Iterator<SubscriptionPlanDTO> it = list.iterator();
        ...
        <div class="row">
            ...
            &emsp;
            <div class="col-sm-2">
                <input type="number" name="validityDays" placeholder="Validity Days"
                    class="form-control" min="1"
                    value="<%=ServletUtility.getParameter("validityDays", request)%>">
            </div>
            &emsp;
            <div class="col-sm-3">
                <input type="submit" class="btn btn-primary btn-md"
                    style="font-size: 15px" name="operation"
                    value="<%=SubscriptionPlanListCtl.OP_SEARCH%>">&emsp;
            ...
            <table class="table table-bordered table-dark table-hover">
                <thead>
                    <tr style="background-color: #8C8C8C;">
                        <th width="10%">
                            <input type="checkbox" id="select_all" name="Select" class="text"> Select All
                        </th>
                        <th width="5%" class="text">S.NO</th>
                        <th width="25%" class="text">Plan Name</th>
                        <th width="20%" class="text">Price</th>
                        <th width="20%" class="text">Validity Days</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text"><%=dto.getPlanName()%></td>
                        <td class="text"><%=dto.getPrice()%></td>
                        <td class="text"><%=dto.getValidityDays()%></td>
                        <td class="text">
                            <a href="SubscriptionPlanCtl?id=<%=dto.getId()%>">Edit</a>
                        </td>
                    </tr>
                </tbody>
                <%
        ...
        <center>
            <h1 style="font-size: 40px; color: #162390;">Subscription Plan List</h1>
        </center>
