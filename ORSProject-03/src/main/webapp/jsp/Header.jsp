    ...
    <div class="dropdown-menu">
        ...
        <a class="dropdown-item" href="<%=ORSView.POLICY_LIST_CTL%>">
            <i class="fa fa-list"></i> Policy List
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="<%=ORSView.VEHICLE_INSURANCE_CTL%>">
							...
							href="<%=ORSView.VEHICLE_INSURANCE_LIST_CTL%>"> <i
							class="fa fa-list"></i> Vehicle Insurance List
						</a>
					</div></li>

				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" data-toggle="dropdown"
					style="color: white;">Mobile Store</a>
					<div class="dropdown-menu">
						<a class="dropdown-item" href="<%=ORSView.MOBILE_STORE_CTL%>">
							<i class="fa fa-mobile-alt"></i> Add Mobile
						</a> <a class="dropdown-item"
							href="<%=ORSView.MOBILE_STORE_LIST_CTL%>"> <i
							class="fa fa-list"></i> Mobile List
						</a>
					</div></li>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" data-toggle="dropdown"
					style="color: white;">Energy Consumption</a>
					<div class="dropdown-menu">
						<a class="dropdown-item"
							href="<%=ORSView.ENERGY_CONSUMPTION_CTL%>"> <i
							class="fa fa-bolt"></i> Add Energy Consumption
						</a> <a class="dropdown-item"
							href="<%=ORSView.ENERGY_CONSUMPTION_LIST_CTL%>"> <i
							class="fa fa-list"></i> Energy Consumption List
						</a>
					</div></li>
				...
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" data-toggle="dropdown"
					style="color: white;">Drone Delivery</a>
					<div class="dropdown-menu">
						<a class="dropdown-item" href="<%=ORSView.DRONE_DELIVERY_CTL%>">
							<i class="fa fa-paper-plane"></i> Add Drone Delivery
						</a> <a class="dropdown-item"
							href="<%=ORSView.DRONE_DELIVERY_LIST_CTL%>"> <i
							class="fa fa-list"></i> Drone Delivery List
						</a>
					</div></li>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" data-toggle="dropdown"
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="<%=ORSView.SMART_PARKING_CTL%>">
							<i class="fa fa-parking"></i> Add Smart Parking
						</a> <a class="dropdown-item"
				...
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" data-toggle="dropdown"
					style="color: white;">AI Recommendation</a>
					<div class="dropdown-menu">
						<a class="dropdown-item" href="<%=ORSView.AI_RECOMMENDATION_CTL%>">
							<i class="fa fa-robot"></i> Add AI Recommendation
						</a> <a class="dropdown-item"
							href="<%=ORSView.AI_RECOMMENDATION_LIST_CTL%>"> <i
							class="fa fa-list"></i> AI Recommendation List
						</a>
					</div></li>
