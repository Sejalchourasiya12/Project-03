...
public class VoiceCommandListCtl extends BaseCtl {
    ...
    protected BaseDTO populateDTO(HttpServletRequest request) {
        ...
        if (commandText == null || commandText.trim().startsWith("--") || commandText.trim().isEmpty()) {
            dto.setCommandText("");
        } else {
            dto.setCommandText(commandText.trim());
        }
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op)) {
                ...
                if (ids != null && ids.length > 0) {
                    VoiceCommandDTO deleteBean = new VoiceCommandDTO();
                    for (String id : ids) {
