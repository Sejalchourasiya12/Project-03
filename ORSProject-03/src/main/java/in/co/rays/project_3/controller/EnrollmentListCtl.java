...
public class EnrollmentListCtl extends BaseCtl {
    ...
    private static Logger log = Logger.getLogger(EnrollmentListCtl.class);

    @Override
    protected boolean validate(HttpServletRequest request) {
        return true; // ✅ Search ke liye validation nahi chahiye
    }
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op)
                ...
                if (ids != null && ids.length > 0) {
                    ...
                    EnrollmentDTO deleteBean = new EnrollmentDTO();
