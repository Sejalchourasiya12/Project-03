...
@WebServlet(name = "WeatherAlertListCtl", urlPatterns = { "/ctl/WeatherAlertListCtl" })
public class WeatherAlertListCtl extends BaseCtl {

    private static Logger log = Logger.getLogger(WeatherAlertListCtl.class);
    ...
    protected BaseDTO populateDTO(HttpServletRequest request) {
        ...
        if (cityName == null || cityName.trim().startsWith("--") || cityName.trim().isEmpty()) {
            dto.setCityName("");
        } else {
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op)) {
                ...
                if (ids != null && ids.length > 0) {
                    WeatherAlertDTO deleteBean = new WeatherAlertDTO();
                    for (String id : ids) {
