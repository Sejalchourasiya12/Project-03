...
@WebServlet(name = "AchievementListCtl", urlPatterns = { "/ctl/AchievementListCtl" })
public class AchievementListCtl extends BaseCtl {

    private static Logger log = Logger.getLogger(AchievementListCtl.class);
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op)) {
                ...
                if (ids != null && ids.length > 0) {
                    AchievementDTO deleteBean = new AchievementDTO();
                    for (String id : ids) {
    ...
    protected String getView() {
        return ORSView.ACHIEVEMENT_LIST_VIEW;
    }
}