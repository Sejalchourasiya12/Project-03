...
@WebServlet(name = "BookIssueListCtl", urlPatterns = { "/ctl/BookIssueListCtl" })
public class BookIssueListCtl extends BaseCtl {

    private static Logger log = Logger.getLogger(BookIssueListCtl.class);
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op)
                ...
                if (ids != null && ids.length > 0) {
                    ...
                    BookIssueDTO deleteBean = new BookIssueDTO();
    ...
    protected String getView() {
        return ORSView.BOOK_ISSUE_LIST_VIEW;
    }
}