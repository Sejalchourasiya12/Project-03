...
@WebServlet(name = "LeaveListCtl", urlPatterns = "/ctl/LeaveListCtl")
public class LeaveListCtl extends BaseCtl {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (OP_SEARCH.equalsIgnoreCase(op)) {
            ...
            if (ids != null) {
                ...
                for (String id : ids) {
                    LeaveDTO deleteDto = new LeaveDTO();
                ...
                ServletUtility.setSuccessMessage("Leave Deleted Successfully", request);
    ...
    protected String getView() {
        return ORSView.LEAVE_LIST_VIEW;
    }
}