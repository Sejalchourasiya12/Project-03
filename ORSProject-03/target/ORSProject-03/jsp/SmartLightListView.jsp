...
<div>
<form class="pb-5"
    action="<%=ORSView.SMART_LIGHT_LIST_CTL%>"
    method="post">
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <input type="text" name="lightCode"
                placeholder="Enter Light Code" class="form-control"
        ...
        <div class="col-sm-2">
            <input type="submit" class="btn btn-primary btn-md"
                ...
                value="<%=SmartLightListCtl.OP_SEARCH%>">
            &nbsp;
    ...
    <table class="table table-bordered table-dark table-hover">
        <thead>
            <tr style="background-color: #8C8C8C;">
                ...
                <th width="15%" class="text">Light Code</th>
                <th width="20%" class="text">Room Name</th>
                <th width="20%" class="text">Brightness Level</th>
        ...
        <tbody>
            <tr>
                ...
                <td class="text">
                    <a href="<%=ORSView.APP_CONTEXT%>/ctl/SmartLightCtl?id=<%=dto.getId()%>">Edit</a>
                </td>
            </tr>
        </tbody>
        <%
        ...
        <tr>
            ...
            <td>
                <input type="submit" name="operation"
                    ...
                    value="<%=SmartLightListCtl.OP_NEW%>">
            </td>
            <td>
                <input type="submit" name="operation"
                    class="btn btn-danger btn-md" style="font-size: 17px"
                    value="<%=SmartLightListCtl.OP_DELETE%>">
            </td>
            <td align="right">
                <input type="submit" name="operation"
                    class="btn btn-warning btn-md" style="font-size: 17px"
    ...
    <center>
        <h1 style="font-size: 40px; color: #162390;">Smart Light List</h1>
    </center>
    <br>
    ...
    <div style="padding-left: 48%;">
        <input type="submit" name="operation"
            class="btn btn-primary btn-md" style="font-size: 17px"
            value="<%=SmartLightListCtl.OP_BACK%>">
    </div>
